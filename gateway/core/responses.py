...
def success_response(
    data: Any = None, msg: str = "success", status_code: int = 200
) -> JSONResponse:
    """
    成功响应
...
def error_response(
    msg: str, code: int = 1000, data: Any = None, status_code: int = 500
) -> JSONResponse:
    """
    错误响应
...
def bad_request_response(
    msg: str = "请求参数错误", code: int = 4000, data: Any = None
) -> JSONResponse:
    """400 Bad Request 响应"""
...
def unauthorized_response(
    msg: str = "未授权，请提供有效的认证信息", code: int = 4010, data: Any = None
) -> JSONResponse:
    """401 Unauthorized 响应"""
...
def forbidden_response(
    msg: str = "禁止访问", code: int = 4030, data: Any = None
) -> JSONResponse:
    """403 Forbidden 响应"""
...
def not_found_response(
    msg: str = "资源不存在", code: int = 4040, data: Any = None
) -> JSONResponse:
    """404 Not Found 响应"""
...
def conflict_response(
    msg: str = "资源冲突", code: int = 4090, data: Any = None
) -> JSONResponse:
    """409 Conflict 响应"""
...
def validation_error_response(
    msg: str = "数据验证失败", code: int = 4220, data: Any = None
) -> JSONResponse:
...
def internal_server_response(
    msg: str = "服务器内部错误", code: int = 5000, data: Any = None
) -> JSONResponse:
...
def service_unavailable_response(
    msg: str = "服务暂时不可用", code: int = 5030, data: Any = None
) -> JSONResponse:
