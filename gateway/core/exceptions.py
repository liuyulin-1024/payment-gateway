...
class BadRequestException(BaseAPIException):
    ...
    def __init__(self, message: str = "请求参数错误", code: int = 4000, details: Any = None):
...
class UnauthorizedException(BaseAPIException):
    ...
    def __init__(self, message: str = "未授权，请提供有效的认证信息", code: int = 4010, details: Any = None):
...
class ForbiddenException(BaseAPIException):
    ...
    def __init__(self, message: str = "禁止访问", code: int = 4030, details: Any = None):
...
class NotFoundException(BaseAPIException):
    ...
    def __init__(self, message: str = "资源不存在", code: int = 4040, details: Any = None):
...
class ConflictException(BaseAPIException):
    ...
    def __init__(self, message: str = "资源冲突", code: int = 4090, details: Any = None):
...
class ValidationException(BaseAPIException):
    ...
    def __init__(self, message: str = "数据验证失败", code: int = 4220, details: Any = None):
...
class InternalServerException(BaseAPIException):
    ...
    def __init__(self, message: str = "服务器内部错误", code: int = 5000, details: Any = None):
...
class ServiceUnavailableException(BaseAPIException):
    ...
    def __init__(self, message: str = "服务暂时不可用", code: int = 5030, details: Any = None):
...
class PaymentProviderException(BaseAPIException):
    ...
    def __init__(self, message: str = "支付渠道异常", code: int = 5020, details: Any = None):
